...
+++ of the NIR reference channel @ 0.865�m and the NIR water vapor channel
...
int year, month, day;
  ...
  // read wvp from LUT
    ...
    // if daily value has nodata, and strict checking is enabled
    if (wvp < 0 && pl2->wvp_strict){
      printf("no daily wvp value available\n"); return -1;}
